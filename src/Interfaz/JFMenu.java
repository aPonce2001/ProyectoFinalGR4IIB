...
public class JFMenu extends javax.swing.JFrame {
    ...
    public JFMenu() {
        ...
        this.jfpais= new JFPais();
        this.jfasiento= new JFAsiento();
        this.jfcliente= new JFCliente();
        jfreserva= new JFReserva();
        jfvuelo=new JFVuelo();
    }
    
    public JFMenu(Conexion conexion) {
        initComponents();
        this.conexion = conexion;
        this.setExtendedState(MAXIMIZED_BOTH);
        this.jfclase=new JFClase(conexion);
        this.jfavion= new JFAvion(conexion);
        this.jfpais= new JFPais(conexion);
        this.jfasiento= new JFAsiento(conexion);
        this.jfcliente= new JFCliente(conexion);
        jfreserva= new JFReserva(conexion);
        jfvuelo=new JFVuelo(conexion);
    }
    ...
    private void jMenuItem1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem1ActionPerformed
        this.jfclase.setVisible(true);
    }//GEN-LAST:event_jMenuItem1ActionPerformed

    private void jMenuItem3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem3ActionPerformed
       this.jfavion.setVisible(true);
    }//GEN-LAST:event_jMenuItem3ActionPerformed

    private void jMenuItem4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem4ActionPerformed
        this.jfpais.setVisible(true);
